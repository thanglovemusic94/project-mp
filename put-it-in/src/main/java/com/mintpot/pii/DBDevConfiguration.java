...
import com.mintpot.pii.exception.ConfigurationException;
...
public class DBDevConfiguration {
    ...
    MariaDB4jSpringService mariaDB4jSpringService(DataSourceProperties dataSourceProperties) {
        ...
        if (matcher.matches()) {
            ...
            var args = new ArrayList<>(Arrays.asList("--character-set-server=utf8", "--collation-server=utf8_general_ci"));
    ...
    DataSource dataSource(
            MariaDB4jSpringService mariaDB4jSpringService, DataSourceProperties dataSrcProperties) throws ManagedProcessException {
