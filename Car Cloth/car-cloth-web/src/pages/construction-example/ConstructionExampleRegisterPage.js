...
export default function ConstructionExampleRegisterPage() {
    ...
    useEffect(() => {
        dispatch({
            type: CONSTRUCTION_REGISTER_TYPE.SET_CONSTRUCTION, payload: {...state, data: {
                    "completedDate": idQuote?.completeDate ?? null,
                    "content": null,
                    "images": [],
                    "quoteId": idQuote?.id ?? null
                }
            }})
                    ...
                    <div className="d-flex flex-column p-3 pb-0 h-100">
                        ...
                        <div className="flex-grow-1 d-flex flex-column">
                            ...
                            <div className="py-3 flex-grow-1">
                                <textarea placeholder="시공 내용을 입력해주세요." onChange={handleChange}
