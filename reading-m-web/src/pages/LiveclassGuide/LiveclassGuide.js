      ...
      <div className="page-details">
        <article className="article-details">
          ...
          <div className="article-download text-right">
            <Button variant="outline-g700" className="btw-290 btn-square">
              다운로드
            </Button>
          </div>
          <div className="article-content">
            ...
            <p>
              누구든지 법률에 의하지 아니하고는 체포·구속·압수·수색 또는 심문을
              받지 아니하며. 국가는 노인과 청소년의 복지향상을 위한 정책을
              실시할 의무를 진다. 이 경우 공무원 자신의 책임은 면제되지
              아니한다.
            </p>
            <p>
              대통령·국무총리·국무위원·행정각부의 장·헌법재판소
