...
const PointEdit = (props) => {
    ...
    function handleEditPointPayment() {
        const parentIdList = data.parents.map(p => p.id);
        PointPaymentService.updatePointPayment({...data, parentIdList: parentIdList}).then((resp) => {
                                    ...
                                    <div className="radio-group-custom">
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                defaultChecked={data.type === "CASH_POINT"}
                                            />
                                            <CLabel
                                                variant="checkbox"
                                                htmlFor="radio1"
                                        ...
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                value="EVENT_POINT"
                                                onChange={(e) => setData({...data, "type": e.target.value})}
                                                defaultChecked={data.type === "EVENT_POINT"}
                                            />
                                            <CLabel
                                                variant="checkbox"
                                                htmlFor="radio2"
                                ...
                                <td>
                                    <CFormGroup variant="custom-radio" inline>
                                        <CInputRadio
                                            ...
                                            defaultChecked={data.issuingMode === "ALL"}
                                        />
                                        <CLabel
                                    ...
                                    <CFormGroup variant="custom-radio" inline>
                                        <CInputRadio
                                            ...
                                            defaultChecked={data.issuingMode === "SELECT"}
                                        />
                                        <CLabel
                                            variant="custom-checkbox"
                    ...
                    <CRow className="justify-content-center mt-5">
                        ...
                        <CCol md="2">
                            <CButton
                                block
                                color="dark"
                                onClick={handleEditPointPayment}
                            >
                                저장
                            </CButton>
                        </CCol>
