...
const CouponEdit = (props) => {
    const [couponDetail, setCouponDetail] = useState({
        "amount": props.location.data.amount,
        "classType": props.location.data.classType,
        "startValidDate": new Date(props.location.data.startValidDate),
        "endValidDate": new Date(props.location.data.endValidDate),
        "id": props.location.data.id,
        "issuingMode": props.location.data.issuingMode,
        "name": props.location.data.name,
        "parents": [...props.location.data.members]
    })
    ...
    function handleEditCoupon() {
        ...
        CouponService.updateCoupon({...couponDetail, parentIdList: parentIdList}).then((resp) => {
            if (resp.status === 204) {
                setSmall(!small)
            }
        })
                                    ...
                                    <div className="radio-group-custom">
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                name="radios"
                                                value=""
                                                defaultChecked={!couponDetail.classType}
                                                onClick={(e) => couponDetail.classType = e.target.value}
                                            />
                                            <CLabel
                                                variant="checkbox"
                                                htmlFor="radio1"
                                        ...
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                defaultChecked={couponDetail.classType === AppliedClass.LIVE_BOOK.value}
                                        ...
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                defaultChecked={couponDetail.classType === AppliedClass.LIVE_GOAL.value}
                                                onChange={(e) => setCouponDetail({...couponDetail, "classType": e.target.value})}
                                            />
                                            <CLabel
                                                variant="checkbox"
                                        ...
                                        <CFormGroup variant="checkbox">
                                            <CInputRadio
                                                ...
                                                defaultChecked={couponDetail.classType === AppliedClass.MATHEMATICS.value}
                                                onChange={(e) => setCouponDetail({...couponDetail, "classType": e.target.value})}
                                            />
                                            <CLabel
                                                variant="checkbox"
                                ...
                                <td>
                                    <CFormGroup variant="custom-radio" inline>
                                        <CInputRadio
                                            ...
                                            defaultChecked={couponDetail.issuingMode === SelectedMemember.ALL.value}
                                    ...
                                    <CFormGroup variant="custom-radio" inline>
                                        <CInputRadio
                                            ...
                                            defaultChecked={couponDetail.issuingMode === SelectedMemember.SELECT.value}
                                    ...
                                    <CButton
                                        ...
                                        hidden={couponDetail.issuingMode === SelectedMemember.ALL.value}
                                    >
